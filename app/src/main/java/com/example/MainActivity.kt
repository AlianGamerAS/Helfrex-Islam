        ...
        setContent {
            ...
            if (!view.isInEditMode) {
                androidx.compose.runtime.SideEffect {
                    ...
                    val navColor = if (settings.isDarkMode) {
                        when (settings.themeStyle) {
                            com.example.model.ThemeStyle.CLASSIC -> android.graphics.Color.parseColor("#1C1B1F")
                            com.example.model.ThemeStyle.NEON_BLUE -> android.graphics.Color.parseColor("#0A181E")
                            com.example.model.ThemeStyle.NEON_PURPLE -> android.graphics.Color.parseColor("#1E0A18")
                            com.example.model.ThemeStyle.NEON_EMERALD -> android.graphics.Color.parseColor("#0A2016")
                        }
                    } else {
                        when (settings.themeStyle) {
                            com.example.model.ThemeStyle.CLASSIC -> android.graphics.Color.parseColor("#F5F5F5")
                            com.example.model.ThemeStyle.NEON_BLUE -> android.graphics.Color.parseColor("#E0F7FA")
                            com.example.model.ThemeStyle.NEON_PURPLE -> android.graphics.Color.parseColor("#FCE7F3")
                            com.example.model.ThemeStyle.NEON_EMERALD -> android.graphics.Color.parseColor("#DCFCE7")
                        }
                    }
                    ...
                    val isLightBar = !settings.isDarkMode
